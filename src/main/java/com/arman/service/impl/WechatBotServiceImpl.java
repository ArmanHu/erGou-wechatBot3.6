...
import com.arman.client.WechatBotClient;
...
public class WechatBotServiceImpl implements WechatBotService, WechatBotCommon {
     ...
     */
    @Override
    public void getChatroomMemberNick(WechatMsg wechatMsg) {
     ...
     */
    @Override
    public void getWeChatRoomMemberList(WechatMsg wechatMsg) {
    	
        wechatMsg.setType(CHATROOM_MEMBER);
        wechatMsg.setContent(ROOM_MEMBER_LIST);
