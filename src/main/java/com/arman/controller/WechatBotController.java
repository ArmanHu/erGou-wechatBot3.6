...
public class WechatBotController {
     ...
     *
     * @param wechatMsg
     * @return com.arman.common.util.AjaxResult
     ...
     * @Date 2021-3-26
     */
    @PostMapping("/getChatroomMemberNick")
    public AjaxResult getChatroomMemberNick(@RequestBody WechatMsg wechatMsg) {
     ...
     * @Date 2021-3-29
     */
    @PostMapping("/getWeChatRoomMemberList")
    public AjaxResult getWeChatRoomMemberList(@RequestBody WechatMsg wechatMsg) {
